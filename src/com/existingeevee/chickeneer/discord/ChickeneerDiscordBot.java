package com.existingeevee.chickeneer.discord;

import java.io.File;

import javax.security.auth.login.LoginException;

import com.existingeevee.chickeneer.discord.events.OnInteraction;
import com.existingeevee.chickeneer.discord.events.OnMessage;
import com.existingeevee.chickeneer.discord.events.OnReady;
...
public class ChickeneerDiscordBot extends ListenerAdapter {
	...
	public void setupBot() {
		...
		builder = JDABuilder.createDefault(Utils.fileread("token.txt").split("\n")[0]);
